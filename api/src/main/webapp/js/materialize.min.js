...
!function (t) {
    ...
    return function (t, e, i, n) {
        ...
        function l(t, i, n, o) {
            ...
            var C = x ? new Float32Array(b) : new Array(b), T = !1, S = function (e) {
        ...
        function u(t) {
            if (t) {
                ...
                for (var a = 0; i > a; a++)if (b.State.calls[a]) {
                    var s = b.State.calls[a], l = s[0], c = s[2], h = s[3], f = !!h, g = null;
                    ...
                    for (var m = Math.min((e - h) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                        ...
                        if (r(T)) {
                            ...
                            for (var A in k)if ("element" !== A) {
                                var O, E = k[A], M = v.isString(E.easing) ? b.Easings[E.easing] : E.easing;
                                if (1 === m) O = E.endValue; else {
                                    var I = E.endValue - E.startValue;
                                    if (O = E.startValue + I * M(m, c, I), !f && O === E.currentValue)continue
                                }
                                if (E.currentValue = O, "tween" === A) g = O; else {
                                    if (x.Hooks.registered[A]) {
                                        var q = x.Hooks.getRoot(A), _ = r(T).rootPropertyValueCache[q];
                ...
                var x = b.CSS = {
                    ...
                    Hooks: {
                        templates: {
                            ...
                            var e, i, n;
                            if (h)for (e in x.Hooks.templates) {
                ...
                var k = function () {
                    ...
                    function o() {
                        function t(t) {
                            ...
                            if ("scroll" === A) {
                                var m, w, k, S = /^x$/i.test(s.axis) ? "Left" : "Top", O = parseFloat(s.offset) || 0;
                                ...
                                for (var V in g) {
                                    var z = d(g[V]), D = z[0], j = z[1], H = z[2];
                                    V = x.Names.camelCase(V);
                                    var L = x.Hooks.getRoot(V), W = !1;
                                    if (r(a).isSVG || "tween" === L || !1 !== x.Names.prefixCheck(L)[1] || x.Normalizations.registered[L] !== n) {
                                        ...
                                        if (N = h(V, H), H = N[0], Q = N[1], N = h(V, D), D = N[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return $ = e, ""
                                            }), F = N[1], H = parseFloat(H) || 0, D = parseFloat(D) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(V) ? (D /= 100, F = "em") : /^scale/.test(V) ? (D /= 100, F = "") : /(Red|Green|Blue)$/i.test(V) && (D = D / 100 * 255, F = "")), /[\/*]/.test($)) F = Q; else if (Q !== F && 0 !== H)if (0 === D) F = Q; else {
                                            o = o || function () {
                                                    var t = {
                    ...
                    if (v.isWrapped(this) ? (s = !1, h = 0, f = this, l = this) : (s = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                            ...
                            default:
                                if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                    if (v.isString(g) && b.Redirects[g]) {
                                        var E = (z = p.extend({}, y)).duration, M = z.delay || 0;
                        ...
                        if (z.loop = parseInt(z.loop), V = 2 * z.loop - 1, z.loop)for (var D = 0; V > D; D++) {
    ...
    function P(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, a = e & kt && 0 == n - o,
            r = e & (Tt | St) && 0 == n - o;
    ...
    function A(t, e) {
        ...
        var a = i.firstInput, r = i.firstMultiple, s = r ? r.center : a.center, l = e.center = I(n);
    ...
    function E(t, e) {
        ...
        if (e.eventType != St && (l > xt || s.velocity === n)) {
            var c = s.deltaX - e.deltaX, u = s.deltaY - e.deltaY, d = q(l, c, u);
    ...
    function M(t) {
        ...
        return {timeStamp: ht(), pointers: e, center: I(e), deltaX: t.deltaX, deltaY: t.deltaY}
    }
    ...
    function Q(t, e) {
        ...
        if (a = i.filter(function (t) {
                return v(t.target, l)
            }), e === kt)for (o = 0; o < a.length;)n[a[o].identifier] = !0, o++;
    ...
    var lt = ["", "webkit", "moz", "MS", "ms", "o"], ct = e.createElement("div"), ut = "function", dt = Math.round,
        pt = Math.abs, ht = Date.now, ft = 1, vt = /mobile|tablet|ip(ad|hone|od)|android/i, gt = "ontouchstart" in t,
        mt = x(t, "PointerEvent") !== n, yt = gt && vt.test(navigator.userAgent), bt = "touch", wt = "mouse", xt = 25,
        kt = 1, Ct = 2, Tt = 4, St = 8, Pt = 1, At = 2, Ot = 4, Et = 8, Mt = 16, It = At | Ot, qt = Et | Mt,
        _t = It | qt, Vt = ["x", "y"], zt = ["clientX", "clientY"];
    T.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var Dt = {mousedown: kt, mousemove: Ct, mouseup: Tt}, jt = "mousedown", Ht = "mousemove mouseup";
    c(H, T, {
        handler: function (t) {
            var e = Dt[t.type];
    ...
    var Lt = {pointerdown: kt, pointermove: Ct, pointerup: Tt, pointercancel: St, pointerout: St},
        Wt = {2: bt, 3: "pen", 4: wt, 5: "kinect"}, Nt = "pointerdown", Ft = "pointermove pointerup pointercancel";
    t.MSPointerEvent && (Nt = "MSPointerDown", Ft = "MSPointerMove MSPointerUp MSPointerCancel"), c(L, T, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Lt[n],
                a = Wt[t.pointerType] || t.pointerType, r = a == bt, s = y(e, t.pointerId, "pointerId");
    ...
    var Qt = {touchstart: kt, touchmove: Ct, touchend: Tt, touchcancel: St}, $t = "touchstart",
    ...
    c(F, T, {
        handler: function (t) {
            var e = Rt[t.type], i = Q.call(this, t, e);
    ...
    var Bt = x(ct.style, "touchAction"), Ut = Bt !== n, Gt = "compute", Zt = "auto", Jt = "manipulation", Kt = "none",
        te = "pan-x", ee = "pan-y";
    X.prototype = {
        set: function (t) {
            ...
            if (!Ut) {
                ...
                var n = this.actions, o = g(n, Kt), a = g(n, ee), r = g(n, te);
    ...
    Y.prototype = {
        ...
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: _t}, getTouchAction: function () {
        ...
        defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & (Tt | St) && !a) this.reset(); else if (t.eventType & kt) this.reset(), this._timer = o(function () {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[et, {enable: !1}], [K, {enable: !1}, ["rotate"]], [it, {direction: It}], [J, {direction: It}, ["swipe"]], [nt], [nt, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [tt]],
        cssProps: {
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (t) {
    ...
    t.fn.scrollTo = function (e) {
        ...
        return "open" === e ? (this.each(function () {
            ...
            function o(e) {
                ...
                var i = window.innerHeight, o = r.innerHeight(), u = r.offset().left,
                    d = r.offset().top - t(window).scrollTop(), p = s.alignment, h = 0, f = 0, v = 0;
                !0 === s.belowOrigin && (v = o);
                var g = 0, m = 0, y = r.parent();
                if (y.is("body") || (y[0].scrollHeight > y[0].clientHeight && (g = y[0].scrollTop), y[0].scrollWidth > y[0].clientWidth && (m = y[0].scrollLeft)), u + c.innerWidth() > t(window).width() ? p = "right" : u - c.innerWidth() + r.innerWidth() < 0 && (p = "left"), d + c.innerHeight() > i)if (d + o - c.innerHeight() < 0) {
                    var b = i - d - v;
                    c.css("max-height", b)
    ...
    var e = 0, i = 0, n = function () {
        ...
        init: function (i) {
            ...
            return i = t.extend(o, i), this.each(function () {
                var o = t(this), a = t(this).attr("id") || "#" + t(this).data("target"), r = function () {
                    var n = o.data("overlay-id"), a = t("#" + n);
                    o.removeClass("open"), t("body").css({
                        overflow: "",
                        width: ""
                    }), o.find(".modal-close").off("click.close"), t(document).off("keyup.modal" + n), a.velocity({opacity: 0}, {
                        duration: i.outDuration,
                        queue: !1,
                        ease: "easeOutQuart"
                    });
                    var r = {
                        duration: i.outDuration, queue: !1, ease: "easeOutCubic", complete: function () {
                            t(this).css({display: "none"}), "function" == typeof i.complete && i.complete.call(this, o), a.remove(), e--
                        }
                    };
                    o.hasClass("bottom-sheet") ? o.velocity({
                        bottom: "-100%",
                        opacity: 0
                    }, r) : o.velocity({top: i.startingTop, opacity: 0, scaleX: .7}, r)
                }, s = function (a) {
                    var s = t("body"), l = s.innerWidth();
                    if (s.css("overflow", "hidden"), s.width(l), !o.hasClass("open")) {
                        var c = n(), u = t('<div class="modal-overlay"></div>'), d = ++e;
                        u.attr("id", c).css("z-index", 1e3 + 2 * d), o.data("overlay-id", c).css("z-index", 1e3 + 2 * d + 1), o.addClass("open"), t("body").append(u), i.dismissible && (u.click(function () {
                            ...
                            r()
                        }), u.css({display: "block", opacity: 0}), o.css({
                            display: "block",
                            opacity: 0
                        }), u.velocity({opacity: i.opacity}, {
                            duration: i.inDuration,
                            queue: !1,
                            ease: "easeOutCubic"
                        }), o.data("associated-overlay", u[0]);
                        var p = {
                            duration: i.inDuration, queue: !1, ease: "easeOutCubic", complete: function () {
                        ...
                        o.hasClass("bottom-sheet") ? o.velocity({
                            bottom: "0",
                            opacity: 1
                        }, p) : (t.Velocity.hook(o, "scaleX", .7), o.css({top: i.startingTop}), o.velocity({
                            top: i.endingTop,
                            opacity: 1,
                            scaleX: "1"
                        }, p))
        ...
        init: function (e) {
            ...
            return this.each(function (i) {
                ...
                e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1), 0 === (o = t(p.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), (g = p.index(o)) < 0 && (g = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"), u.find(".indicator").length || u.append('<li class="indicator"></li>'), s = u.find(".indicator"), u.append(s), u.is(":visible") && setTimeout(function () {
                    ...
                    h = u.width(), v = Math.max(h, u[0].scrollWidth) / p.length, g < 0 && (g = 0), 0 !== v && 0 !== h && (s.css({right: y(o)}), s.css({left: b(o)}))
                ...
                "mouseenter.tooltip": function (t) {
                    p = setTimeout(function () {
                        ...
                        var t, i, n, a = o.outerWidth(), r = o.outerHeight(), l = c.outerHeight(), p = c.outerWidth(),
                            f = "0px", v = "0px", g = u[0].offsetWidth, m = u[0].offsetHeight, y = 8, b = 8, w = 0;
    ...
    var a = function (t) {
        ...
        if (e.classList.add("toast"), i)for (var o = i.split(" "), a = 0, r = o.length; a < r; a++)e.classList.add(o[a]);
        ...
        return s.on("pan", function (t) {
            ...
            var i = t.deltaX;
            Math.abs(i) > 80 ? Vel(e, {marginTop: "-40px"}, {
                duration: 375,
                easing: "easeOutExpo",
                queue: !1,
                complete: function () {
    ...
    t && o.appendChild(a), a.style.opacity = 0, Vel(a, {translateY: "-35px", opacity: 1}, {
        duration: 300,
        easing: "easeOutCubic",
        queue: !1
    });
    ...
    t(document).ready(function () {
                ...
                if (!t.isEmptyObject(o)) {
                    ...
                    n.off("blur.autocomplete").on("blur.autocomplete", function () {
                        ...
                        if (13 !== r.which && 38 !== r.which && 40 !== r.which) {
                            if (i !== s && (p(), s.length >= e.minLength))for (var l in o)if (o.hasOwnProperty(l) && -1 !== l.toLowerCase().indexOf(s) && l.toLowerCase() !== s) {
                                if (a >= e.limit)break;
                                var d = t("<li></li>");
        ...
        t(this).each(function () {
            ...
            if (!n.hasClass("browser-default")) {
                var o = !!n.attr("multiple"), a = n.data("select-id");
                if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
                    ...
                    g.on("keydown", function (e) {
                        ...
                        } else g.trigger("open"); else g.trigger("close")
                    })
    ...
    function e(a, s, u, d) {
        ...
        function f() {
            T.$root.on({
                ...
                var e = t(this), i = e.data(), n = e.hasClass(x.navDisabled) || e.hasClass(x.disabled), o = r();
        ...
        var y = !1, b = {id: a.id || "P" + Math.abs(~~(Math.random() * new Date))},
            w = u ? t.extend(!0, {}, u.defaults, d) : d || {}, x = t.extend({}, e.klasses(), w.klass), k = t(a),
            C = function () {
                return this.start()
            }, T = C.prototype = {
    ...
    function n(n, r) {
        function l(t, e) {
            var i = d.offset(), n = /^touch/.test(t.type), o = i.left + m, a = i.top + m,
        ...
        var u = a(C), d = u.find(".clockpicker-plate"), v = u.find(".picker__holder"), g = u.find(".clockpicker-hours"),
        ...
        if (r.twelvehour)for (M = 1; M < 13; M += 1)I = V.clone(), q = M / 6 * Math.PI, _ = y, I.css({
            left: m + Math.sin(q) * _ - w,
            top: m - Math.cos(q) * _ - w
        }), I.html(0 === M ? "00" : M), g.append(I), I.on(p, l); else for (M = 0; M < 24; M += 1)I = V.clone(), q = M / 6 * Math.PI, _ = M > 0 && M < 13 ? b : y, I.css({
            left: m + Math.sin(q) * _ - w,
            top: m - Math.cos(q) * _ - w
        ...
        if (d.on(p, function (t) {
            ...
            var z = u.find(".clockpicker-canvas"), D = t("svg");
    ...
    var a = window.jQuery, r = a(window), s = a(document), l = "http://www.w3.org/2000/svg",
        ...
        v = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, g = 0, m = 135, y = 105,
        b = 80, w = 20, x = 2 * m, k = u ? 350 : 1,
    ...
    n.DEFAULTS = {
        ...
        if (p.twelvehour && (f = y), s < 0 && (s = 2 * Math.PI + s), r = Math.round(s / u), s = r * u, p.twelvehour ? l ? 0 === r && (r = 12) : (n && (r *= 5), 60 === r && (r = 0)) : l ? (12 === r && (r = 0), r = h ? 0 === r ? 12 : r : 0 === r ? 0 : r + 12) : (n && (r *= 5), 60 === r && (r = 0)), this[this.currentView] !== r && v && this.options.vibrate && (this.vibrateTimer || (navigator[v](10), this.vibrateTimer = setTimeout(a.proxy(function () {
            ...
            var g = Math.sin(s) * (f - w), m = -Math.cos(s) * (f - w), x = Math.sin(s) * f, k = -Math.cos(s) * f;
            ...
            return this.each(function (i) {
                ...
                function s(i) {
                    ...
                    if (b = "number" == typeof i ? i : b, w = Math.floor((b + k / 2) / k), a = b - w * k, s = a < 0 ? 1 : -1, l = -s * a * 2 / k, o = C >> 1, e.fullWidth ? u = "translateX(0)" : (u = "translateX(" + (W[0].clientWidth - g) / 2 + "px) ", u += "translateY(" + (W[0].clientHeight - m) / 2 + "px)"), N) {
                        var p = w % C, h = j.find(".indicator-item.active");
                ...
                function h(t) {
                    var e, i;
                    if (x)if (e = o(t), y = a(t), i = T - e, Math.abs(S - y) < 30 && !z) (i > 2 || i < -2) && (V = !0, T = e, s(b + i)); else {
                ...
                var v, g, m, b, w, x, k, C, T, S, P, A, O, E, M, I, q, _, V, z, D = n + i,
                    j = t('<ul class="indicators"></ul>'), H = null, L = null, W = t(this),
            ...
            return this.each(function () {
                ...
                var l = function () {
                    ...
                    var c = i.outerWidth(), u = i.outerHeight(),
                        ...
                        f = t(window).height(), v = h / 2, g = f / 2, m = p <= v, y = p > v, b = d <= g, w = d > g,
                        x = p >= .25 * h && p <= .75 * h, k = n.outerWidth(), C = n.outerHeight(),
                        T = d + u / 2 - C / 2, S = p + c / 2 - k / 2, P = e ? "fixed" : "absolute",
                        A = x ? k : k / 2 + c, O = C / 2, E = b ? C / 2 : 0, M = m && !x ? k / 2 - c : 0, I = c,
                        q = w ? "bottom" : "top", _ = 2 * c, V = _, z = C / 2 - V / 2, D = k / 2 - _ / 2, j = {};
                    j.top = b ? T : "", j.right = y ? h - S - k : "", j.bottom = w ? f - T - C : "", j.left = m ? S : "", j.position = P, o.css(j), s.css({
                        ...
                        padding: I,
                        verticalAlign: q
                    }), a.css({top: z, left: D, width: _, height: V})
                };
